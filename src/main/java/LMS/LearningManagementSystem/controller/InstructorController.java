...
public class InstructorController {
    ...
    @PostMapping("/add-lesson/{instructorId}/{courseId}")
    public ResponseEntity<String> addLesson(@PathVariable int instructorId, @RequestBody Lesson lesson, @PathVariable int courseId) {
        try {
            instructorService.addLesson(instructorId, lesson, courseId);
